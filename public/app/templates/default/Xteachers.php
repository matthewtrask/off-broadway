...
<div class="container" id="bios">
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <img src="<?php echo IMGDIR; ?>shannon_mayer.jpg" alt="" class="img-responsive center-block">
...
<div class="container" id="bios">
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <img src="<?php echo IMGDIR; ?>erin_obd.jpg" alt="" class="img-responsive center-block">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <img src="<?php echo IMGDIR;?>AmyNoelWelch.jpg" class="img-responsive center-block">
