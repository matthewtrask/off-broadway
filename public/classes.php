...
<main class="body">
	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<h1 class="text-center">CLASSES TO CONNECT WITH OFF BROADWAY IN 2015-2016</h1>
			</div>
		</div>
	</div>
	<!-- Preschool -->
	<div class="container">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				...
				<h4>Wonder Series (Preschoolers Ages 3-5) This series of classes are geared towards the preschool aged child and gives them a chance to use their imaginations and learn about theatre through their sense of wonder.</h4>
			</div>
		</div>
	</div>
	...
	<div class="container classes-offered">
		<div class="row">
			...
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
				<h2>Playdate Ages 3-5</h2>
				<p>Each week a new journey is taken as stories come to life through creative drama and movement activities. Social development, public speaking and theatre concepts combine in this fun creative exploration. This independent class experience is appropriate for both beginning and returning students. Family and friends are invited to a Sharing on the final class day.<span style="color:white; opacity: 0.1">hrough fun games and exercises and songs and working as an ensemble to bring those moments to life. We will cover selections from Annie, Peter Pan, Seussical, Honk and many more to help keep the cl</span></p>
				<p>Fridays 10:00-11:00 AM | Saturdays: 9:00-10:00 AM</p>
				<p>Tuition: $55.00</p>
				<button class="btn btn-block btn-primary" id="btn"><a href="https://app.jackrabbitclass.com/reg.asp?id=277946">Register for this class</a></button>
			</div>
		</div><hr />
	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<h2 class="text-center">Elementary &amp; Middle School Connections</h2>
				<h4>Discovery Series (Ages 5-Middle School) This series of classes is meant for the elementary and middle schooled age student. Students will explore their interest in the arts to connect with their true passion through games, exercises and guidance from the instructors.</h4>
			</div>
		</div>
	</div>
	<div class="container classes-offered">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
				<h2>Junior  Musical Theatre Ages 5-7</h2>
	...
	<div class="container classes-offered">
		<div class="row">
			...
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
				...
				<p>Come take a journey with Ms. Shannon and her infectious teaching style as she helps your young performer connect with the song to tell the story. This is a great way for the young performer to get the basics of all the elements of what Musical Theater is: song- dance and acting. We will attack stage basics, auditions, building a character that conveys a story through song and working as an ensemble to bring those moments to life.  We will cover selections from Annie, Peter Pan, Seussical, Honk and many more to help keep the class fresh and challenging.<span style="color: white; opacity: 0.1">have periodic showcases through the year to showcase their growtasdasd</span></p>
	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<h2 class="text-center">Middle &amp; High School</h2>
				<h4>Passion Series (Ages 10-16) These classes are geared toward the middle and high school aged students. These students will connect with their passion in the arts through exercises, games and classes and guidance from professional instructors.</h4>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
			<h2>OBCT Apprentice Company-Ages 5-12 (Audition Only)</h2>
			<p>Saturday 9:00-12:00 PM</p>
			<p>Tuition: $90.00</p>
		</div>
		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
			<h2>OBCT Troupe-Ages 8-15 <br>(Audition Only)</h2>
			<p>Saturday 11:00-5:00 PM</p>
			<p>Tuition: $110.00</p>
		</div>
	</div>
