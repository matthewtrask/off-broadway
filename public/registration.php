	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<h1 class="text-center">How to register for classes.</h1>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
				...
				<p class="text-center"><b>Studio Etiquette</b></p>
				<p class="text-center">We request and expect students and parents to be respectful to instructors, other students and other parents. Please refrain from profanity, negative attitudes, harmful behavior, hurtful gossip and disrespect in any form in our studios. Anyone engaging in such conduct may be asked to leave. While students, parents, siblings and observers are welcome in the lobby, we ask that there be no running, shouting or disruptive behavior in the lobby or elsewhere in any of the classrooms, changing rooms or hallways. Children not taking classes must not be left alone without adult supervision. Eating is allowed on the tables provided in the lobby but please clean up after yourself before leaving. Only water bottles are allowed in the classroom studios—no food, sodas or gum.<br /><br />In the interest of safety, do not park at curbside for pickup and drop off — have your child wait until someone comes in the studio to pick them up.</p>
				<p class="text-center"><b>Studio Closings</b></p>
				<p class="text-center">Closed days for inclement weather and holidays will coincide with Fulton County School closings, however on teacher workdays our studios will be open. In addition, when Halloween falls on a class day, our studios will be closed.</p>
			</div>
			<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
				<h2 class="text-center">Enrollment &amp; Registration Fees</h2>
				<p class="text-center"><b>Each student: $35 Registration; each additional student in family: $25
										  (All fees are non-refundable)</b></p><br />
				<p class="text-center">Tution can be paid four different ways for your convience:</p>
					<ul>
						<li>Ten monthly payments -- we can store your credit card for monthly payments. </li>
						<li>Pay monthly by credit card, cash or check</li>
						<li>Full ten month tuition payment split into 2 payments -- August and January
							(You will receive a 5% discount!)</li>
						<li>One payment for the entire ten-month season with a 10% discount.
				...
				<p class="text-center"><b>Note:</b> If withdrawing from any class, written notice is required before the first of the next month; missed classes are not eligible for any refunds but can be made up according to prior scheduling. Account statements and announcements are not mailed—please read bulletins, e-mails, newsletters and postings in the studio for vital information on events, rehearsals, etc.</p>
				<p class="text-center"><b>Open class tuition is scaled as follows:</b></p>
					<ul>
						<li>$55/month ... 1st one-hour class</li>
