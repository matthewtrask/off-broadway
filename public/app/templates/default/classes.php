...
<div class="container" style="margin-top: -200px">
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" class="OBDClass">
...
<div class="container classes-offered">
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6" class="OBDClass">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6" class="OBDClass">
      ...
      <p>Each week a new journey is taken as stories come to life through creative drama and movement activities. Social development, public speaking and theatre concepts combine in this fun creative exploration. This independent class experience is appropriate for both beginning and returning students. Family and friends are invited to a Sharing on the final class day.</p>
      <p>Saturdays: 9:00-10:00 AM</p>
      <p>Tuition: $55.00</p>
      <button class="btn btn-block btn-primary" id="btn"><a href="https://app.jackrabbitclass.com/reg.asp?id=277946">Register for this class</a></button>
    </div>
  </div><hr />
