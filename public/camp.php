...
<main class="body">
	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<img src="img/summercamp.jpg" height="20%" width="20%" class="img-responsive center-block"><hr />
				<h4 class="text-center" style="margin-bottom: 20px"><b>To Register, email us at <a href="mailto:offbroadway@msn.com">offbroadway@msn.com</a> or call 770-664-2410</b></h4>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
				<img src="img/jb.jpg" alt="" class="img-responsive center-block">
				<h4 class="text-center">JungleBook Kids</h4>
