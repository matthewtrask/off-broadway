...
<main class="body">
	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<h1 class="text-center">Classes that we offer at Off Broadway Performance Center</h1>
			</div>
		</div>
	</div>
	<!-- Preschool -->
		...
		<div class="row">
			...
			<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
				<ul class="text-center"><h4><b>Days Offered</b></h4><hr />
					<li>Tuesdays 10am-11am (Shannon Mayer)</li>
					<li>Fridays 10am-11am (Shannon Mayer)</li>
					<li>Saturdays 10am-11am (Erin Greenway)</li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="container classes-offered">
		<div class="row">
			...
			<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
				<ul class="text-center"><h4><b>Days Offered</b></h4><hr />
					<li>Tuesday 5pm-6pm (Shannon Mayer)</li>
					<li>Thursday 5pm-6pm (Shannon Mayer)</li>
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="row">
			...
			<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
				<ul class="text-center">
					<li>Thursday 4pm-5pm (Shannon Waggenbrenner)</li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="container classes-offered">
		<div class="row">
			...
			<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
				<ul class="text-center">
					<li>Wednesday 5:30pm-6:30pm (Shannon Mayer)</li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="container classes-offered">
		<div class="row">
			...
			<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
				<ul class="text-center">
					<li>Saturdays 12pm-1:30pm (Christian Mayer)</li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="container classes-offered">
		<div class="row">
			...
			<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
				<ul class="text-center">
					<li>Thursday 6pm-7pm (Shannon Mayer)</li>
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="row">
			...
			<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
				<ul class="text-center"><h4 class="text-center"><b>Days Offered</b></h4><hr />
					<li>Monday 7pm-8pm (Erin Greenway)</li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="container classes-offered">
		<div class="row">
			...
			<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
				<ul class="text-center">
					<li>Mondays 6pm-7pm (Christian Mayer)</li>
				</ul>
			</div>
		</div>
	</div>
